...
const Input = <TFieldValues extends FieldValues>({ type, name, placeholder, register, error, className = '', isFullWidth = true, disabled = false, defaultValue, value }: InputProps<TFieldValues>) => {
  const baseClasses =
